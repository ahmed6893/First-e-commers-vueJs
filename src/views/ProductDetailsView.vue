        ...
        <div class="container">
                        ...
                        <div class="product-images">
                            <main id="gallery">
                                ...
                                <div class="images">
                                    ...
                                    <img v-for="(otherImage , imageKey) in product.product_images"
                                         :key="imageKey"
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <div class="row">
                                <p class="info-text">
                                    <b>Color:</b>
                                    <label v-for="(colorItem, index) in product.product_colors" :key="index" class="me-2">
                                        <input type="radio" :value="colorItem.color.name" v-model="selectedColor" :checked="index === 0" name="color"/>
                                        {{ colorItem.color.name }}
                                    </label>
                                </p>
                                <p class="info-text">
                                    <b>Size:</b>
                                    <label v-for="(sizeItem, index) in product.product_sizes" :key="index" class="me-2">
                                        <input type="radio" :value="sizeItem.size.name" v-model="selectedSize" :checked="index === 0" name="size"/>
                                        {{ sizeItem.size.name }}
                                    </label>
                                </p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="number" v-model="qty" class="form-control" min="1"/>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="product-details-info">
                <div class="single-block">
                    <div class="row">
                        <div class="col-12" v-html="product.long_description">
                        </div>
                    </div>
                </div>
                <div class="row">
...
<script>
    ...
    export default {
        ...
        mounted() {
            axios.get(`http://localhost/project-works/public/api/get-product-details/${this.id}`).then(res => {
                this.product = res.data;

                if (this.product.product_colors?.length) {
                    this.selectedColor = this.product.product_colors[0].color.name;
                }
                if (this.product.product_sizes?.length) {
                    this.selectedSize = this.product.product_sizes[0].size.name;
                }
            }).catch(error => {
        ...
        methods:{
            ...
            getProductDetails()
            {
                axios.get("http://localhost/project-works/public/api/get-product-details/"+this.id).then((response) => {console.log(response.data)
