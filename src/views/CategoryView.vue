                    ...
                    <div class="product-grids-head">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-grid" role="tabpanel" aria-labelledby="nav-grid-tab">
                                <div class="row">
                                    <div class="col-lg-4 col-md-6 col-12" v-for="(product ,key) in filteredProducts" :key="key">
...
<script>
    ...
    export default {
        ...
        computed: {
            filteredProducts() {
                return this.products.filter(p => p && p.id);
            }
        },
        created() {
        ...
        methods: {
            getAllCategoryProduct() {
                axios.get("http://localhost/project-works/public/api/get-all-CategoryProducts/" + this.id)
                    .then((response) => {
